            ...
            <TabPane label="催收信息" name="case_detail_remark_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_remark_list_spin"></Spin>
                <!-- 分页 -->
            ...
            <TabPane label="回款信息" name="case_detail_repay_ord_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_repay_ord_list_spin"></Spin>
                <!-- 分页 -->
                <div class="vue-panel-page">
                  <div class="fr">
                    <Page
            ...
            <TabPane label="用户主动还款" name="case_detail_user_repay_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_user_repay_list_spin"></Spin>
                <!-- 分页 -->
                <div class="vue-panel-page">
                  <div class="fr">
                    <Page
            ...
            <TabPane label="系统代扣还款" name="case_detail_system_repay_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_system_repay_list_spin"></Spin>
          ...
          <Tabs type="card" @on-click="tabClick" size="small" :animated="false">
            <TabPane label="用户绑卡信息" name="case_detail_bindcard_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_bindcard_list_spin"></Spin>
                <!-- 分页 -->
                <div class="vue-panel-page">
                  <div class="fr">
                    <Page
            ...
            <TabPane label="操作记录" name="case_detail_getcaselog">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_getcaselog_spin"></Spin>
                <!-- 分页 -->
                <div class="vue-panel-page">
                  <div class="fr">
                    <Page
            ...
            <TabPane label="站内信记录" name="case_detail_siteletter_list">
              <div>
                <Table
                  ...
                  stripe
                ></Table>
                <Spin size="large" fix v-if="case_detail_siteletter_list_spin"></Spin>
            ...
            <TabPane label="地址信息" name="case_detail_address_info">
              <div class="panel-desc">
                ...
                <Spin size="large" fix v-if="case_detail_address_info_spin"></Spin>
              </div>
            </TabPane>
          </Tabs>
        </p>
