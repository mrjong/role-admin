export default {
	'/system/data_dictionary_page': () => import('@/pages/system/data_dictionary_page'),
	'/system/menu_manager_page': () => import('@/pages/system/menu_manager_page'),
	'/system/relationship_maintain_page': () => import('@/pages/system/relationship_maintain_page'),
