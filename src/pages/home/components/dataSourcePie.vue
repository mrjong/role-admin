...
import { statistics_order_list } from "@/service/getData"
...
export default {
    ...
    series : [
        ...
        this.statistics_order_list2(data)
        },
    async statistics_order_list2(data) {
      const res = await statistics_order_list(data)
      if(res){
