      ...
      >
        <Row>
          <Col :xs="24" :sm="24" :md="6" :lg="6" span="6">
            <FormItem label="用户IP:">
              <Input size="small" clearable v-model.trim="formItem.userIp" placeholder="请输入用户IP"></Input>
            </FormItem>
          </Col>
          <Col :xs="24" :sm="24" :md="6" :lg="6" span="6">
            <FormItem label="用户名称:">
              <Input size="small" clearable v-model.trim="formItem.userName" placeholder="请输入用户名称"></Input>
            </FormItem>
          </Col>
          <Col :xs="24" :sm="24" :md="6" :lg="6" span="6">
            <FormItem label="登录时间:">
              <DatePicker
                size="small"
                style="width:100%"
                v-model="formItem.loginDateRange"
                format="yyyy-MM-dd"
                type="daterange"
          ...
          <Col :xs="24" :sm="24" :md="6" :lg="6" span="6">
            <FormItem label="登出时间:">
              <DatePicker
                size="small"
                style="width:100%"
                v-model="formItem.logoutDateRange"
                format="yyyy-MM-dd"
                type="daterange"
                placement="bottom-start"
                placeholder="请选择时间"
