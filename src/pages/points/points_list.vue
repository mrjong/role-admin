...
<script>
import { points_list, points_del } from "@/service/getData"
    ...
    return {
      ...
      tableColumns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            const row = params.row
            const process_type = row.process_type
              ? filters.process_type(row.process_type)
              : row.process_type
            return h("span", process_type)
          }
        },
